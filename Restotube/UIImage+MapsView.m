...
+ (UIImage *) restaurantTitleImageWithTitle:(NSString *)title
{
    ...
    UIImage *imageBackground = [[UIImage imageNamed:@"map_restaurant_label.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 4, 0, 4)];
    ...
    [imageViewMid setImage:[UIImage imageNamed:@"map_restaurant_label_mid.png"]];
